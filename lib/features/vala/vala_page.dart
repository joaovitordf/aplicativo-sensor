...
class _ValaView extends StatelessWidget {
            ...
            children: [
              Expanded(
                child: DropdownButtonFormField<String?>(
                  ...
                  items: const [
                    DropdownMenuItem(value: 'presenca_vala', child: Text('Presença de Vala')),
                    DropdownMenuItem(value: 'presenca_escora', child: Text('Presença de Escora')),
                    DropdownMenuItem(value: 'todas', child: Text('Todas (Vala e Escora)')),
                  ],
  ...
  Widget _buildBody(BuildContext context, ValaViewModel viewModel) {
  ...
  Widget _buildPaginationFooter(ValaViewModel viewModel) {
    return Container(
